...
<div class="m-0 p-0 outline-0 border-0 font-500 font-outfit text-2xl">
        ...
        <div class=" flex bg-white bg-no-repeat bg-cover overflow-hidden justify-between space-x-40 pl-20 pr-20 h-[600px]  w-5/6 ml-36  p-8">
            ...
            <div class="">
                ...
                <div class="flex flex-row justify-between">
                    <h1 class="text-2xl font-medium  text-slate-600 pb-5"><i class="fa-solid fa-user-tag"></i>: {{Details.tags.join(', ')}}
                    </h1>
